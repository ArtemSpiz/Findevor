					...
					<div className='SecurMain-cont'>
						<div className='securMain-top'>
							<div className='main-texts'>
								<div className='main-company-subtitle'>Company</div>
								...
								<div className='center-stars'>
									...
									<div className='secur-main-subtitle'>
										Our people combine exceptional talent with premium
										technology to drive meaningful impact.
									</div>
