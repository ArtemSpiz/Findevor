	...
	React.useEffect(() => {
		...
		const screensTimeline = gsap.timeline({
			scrollTrigger: {
				...
				onEnter: () => {
					setTimeout(() => {
						screensTimeline.play() // Start animation after delay
					}, 1000) // 1-second delay
				},
				onLeaveBack: () => {
					screensTimeline.pause(0) // Reset animation when scrolling back
				},
			},
	...
	return (
		<>
			<div className='allScreens ' ref={screensRef}>
				...
				{/* secondScreen */}
				<div className='screensSecond screen'>
					<div className='screens-container'>
						<div className='screen-left'>
							<div className='screen-stars'>
								<svg
				...
				{/* thirdScreen */}
				<div className='screensThird screen'>
					<div className='screens-container'>
						<div className='screen-left'>
							<div className='screen-stars'>
								<svg
