		...
		const screensTimeline = gsap.timeline({
			...
			scrollTrigger: {
				...
				onUpdate(self) {
					...
					// Вирахувати кількість активних зірочок
					const activeStars = Math.ceil(progress * stars.length)
					// Оновити заповнення зірочок
					stars.forEach((star, index) => {
						if (index < activeStars) {
							star.classList.remove('nonActive')
						} else {
							star.classList.add('nonActive')
						}
					})
				},
			},
				...
				<div className='screens screen'>
					<div className='screens-container'>
						...
						<div className='firstScreens screen-section'>
							<div className='screensLeftFill' ref={screensLeftFillRef}>
								<div className='screensLeft'>
								...
								<div className='screensLeft'>
									<div className='thirdScreen-left'>
