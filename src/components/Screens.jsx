...
export function Screens() {
	// React.useEffect(() => {
	// 	// First section animation with its own ScrollTrigger
	// 	gsap
	// 		.timeline({
	// 			scrollTrigger: {
	// 				trigger: '.screens',
	...
	// 		)
	// 		.fromTo(
	// 			'.thirdScreen-left-title',
	// 			{ opacity: 0, y: 50 },
	// 			{ opacity: 1, y: 0, duration: 1 },
	// 			'-=0.5'
	// 		)
	// 		.fromTo(
	// 			'.thirdScreen-left-container',
	// 			{ opacity: 0, y: 50 },
	// 			{ opacity: 1, y: 0, duration: 1 },
	// 			'-=0.5'
	// 		)
			...
			<div className='screens '>
				<div className='screens-container'>
					<div className='screen-left'>
						...
						<div className='firstScreen-texts'>
							...
							<div className='firstScreen-text'>
								...
								autonomously to uncover missed opportunities to grow your book
								of business within risk appetite.
							</div>
						</div>
					</div>
					<div className='firstScreens screen-section'>
						<div className='firstScreen-left'>
							<div className='firstScreen-left-container'>
								<div className='firstScreen-left-Top'>
									<div className='firstScreen-left-title'>PRO-AI’s Chat</div>
									<img
										src={leftFirstScreen}
										alt='leftFirstScreen'
									...
									<div className='firstScreen-left-footerText'>
										...
										>
											...
											<defs>
												...
												>
													<stop offset='0.686804' stop-color='#1D2738' />
						...
						<div className='firstScreen-right'>
							<div className='firstScreen-right-container'>
								<div className='firstScreen-title-right'>PRO-AI Platform</div>
								<div className='firstScreen-subtitles'>
									...
									<div className='firstScreen-subtitle subtitleNonAct'>
										Pre-Qualifier
									</div>
									<div className='firstScreen-subtitle subtitleNonAct'>
										Step-Up
								...
								<div className='firstScreenFill'>
									<div className='firstScreenFill-container'>
										<div className='first ScreenFill-cards'>
			...
			<div className='screensSecond'>
				<div className='screens-container'>
					<div className='screen-left'>
						...
						<div className='secondScreen-texts'>
							<div className='firstScreen-titles'>
								<div className='firstScreen-title'>Pre-Qualifier</div>
								<div className='firstScreen-title2'>Assistance </div>
							</div>
							<div className='firstScreen-text'>
								Pre-Qualifier triages submissions based on appetite to enhance
								turnarounds, conversions, and underwriting adherence.
							</div>
						</div>
					</div>
					<div className='secondScreens screen-section'>
						<div className='secondScreens-left'>
							<div className='secondScreens-left-container'>
								<div className='secondScreen-left-title '>PRO-AI Platform</div>
									...
									<div className='secondScreen-left-container'>
										<div className='secondScreen-fill-left'>
											...
											<div className='secondScreenFill-subtitles'>
												<div className='cardTop-subtitle'>Risk Score</div>
												<div className=' number'>68/100</div>
												<div className='cardTop-subtitle'>(Moderate Risk)</div>
											</div>
						...
						<div className='firstScreen-right'>
							<div className='secondScreen-right-container'>
								<div className='firstScreen-title-right'>PRO-AI Platform</div>
								<div className='firstScreen-subtitles'>
									<div className='firstScreen-subtitle subtitleNonAct'>SAM</div>
									<div className='firstScreen-subtitle '>
										<svg
											xmlns='http://www.w3.org/2000/svg'
											width='24'
			...
			<div className='screensThird'>
				<div className='screens-container'>
					<div className='screen-left'>
						...
						<div className='thirdScreen-texts'>
							<div className='firstScreen-titles'>
								<div className='firstScreen-title2'>Step-Up </div>
								<div className='firstScreen-title'>Underwriting </div>
							</div>
							<div className='firstScreen-text'>
								Step-Up Underwriting runs simulations to reevaluate previously
								rejected submissions using new underwriting criteria.
							</div>
						</div>
					</div>
					<div className='thirdScreens screen-section '>
						<div className='firstScreen-left'>
							<div className='thirdScreen-left-container'>
								<div className='firstScreen-left-Top'>
									<div className='thirdScreen-left-title'>PRO-AI’s Chat</div>
									<img
